...
ver = "_v3"
traj_matrix = data.matrix(read.table(paste(path_infile2,"/TrajMatrix_DeltaThr",thres,"_DonorThr",donor_thres,"_",measure_type,ver,".txt",sep=""),header=F,sep="\t"))
cellpop_donor = read.table(paste(path_infile2,"/TrajMatrixLabels_DeltaThr",thres,"_DonorThr",donor_thres,"_",measure_type,ver,".txt",sep=""),header=F,colClass="character",stringsAsFactors=F,sep="\t")
...
outfile = paste(path_outfile,"/DeltaThr",thres,"_DonorThr",donor_thres,"_",measure_type,"_",method,"_",clustering_method,"_ClusterMeasures",ver,".txt",sep="")
write(t(output),ncol=ncol(output),file=outfile)

outfile = paste(path_outfile,"/DeltaThr",thres,"_DonorThr",donor_thres,"_",measure_type,"_",method,"_",clustering_method,"_ClusterMeasures",ver,".pdf",sep="")
...
outfile = paste(path_outfile,"/DeltaThr",thres,"_DonorThr",donor_thres,"_",measure_type,"_",method,"_",clustering_method,"_deepSplit",deepSplit_param[run_select],"_minClusterSize",minClusterSize_param[run_select],ver,".pdf",sep="")
pdf(outfile)
...
outfile = paste(path_outfile,"/DeltaThr",thres,"_DonorThr",donor_thres,"_",measure_type,"_",method,"_",clustering_method,"_deepSplit",deepSplit_param[run_select],"_minClusterSize",minClusterSize_param[run_select],"_DonorScores",ver,".txt",sep="")
...
outfile = paste(path_outfile,"/DeltaThr",thres,"_DonorThr",donor_thres,"_",measure_type,"_",method,"_",clustering_method,"_deepSplit",deepSplit_param[run_select],"_minClusterSize",minClusterSize_param[run_select],"_CPs",ver,".txt",sep="")
...
# 2. Donors vs Module
outfile = paste(path_outfile,"/DeltaThr",thres,"_DonorThr",donor_thres,"_",measure_type,"_",method,"_",clustering_method,"_deepSplit",deepSplit_param[run_select],"_minClusterSize",minClusterSize_param[run_select],"_Donors",ver,".txt",sep="")
...
# 3. Module profiles
outfile = paste(path_outfile,"/DeltaThr",thres,"_DonorThr",donor_thres,"_",measure_type,"_",method,"_",clustering_method,"_deepSplit",deepSplit_param[run_select],"_minClusterSize",minClusterSize_param[run_select],"_Modules",ver,".txt",sep="")
