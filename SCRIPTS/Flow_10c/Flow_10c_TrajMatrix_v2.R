...
"H5N1_Tcell-H5N1-Tcell","H5N1_Thelper-Thelper","H5N1_Treg-H5N1-Treg")
...
infile[4] = paste0(infile[4], ver) # Thelper tube versions
...
outfile = paste(path_outfile,"/TrajMatrixLabels_AllCPs_",measure_type,".txt",sep="")
write(t(traj_labels_ALL),ncol=ncol(traj_labels_ALL),file=outfile,sep="\t")

outfile = paste(path_outfile,"/TrajMatrix_DeltaThr",thres,"_DonorThr",donor_thres,"_",measure_type,".txt",sep="")
write(t(traj_matrix_filtered),ncol=ncol(traj_matrix_filtered),file=outfile,sep="\t")
outfile = paste(path_outfile,"/TrajMatrixLabels_DeltaThr",thres,"_DonorThr",donor_thres,"_",measure_type,".txt",sep="")
