...
# FLOW PATTERN SCORES
ver = "_v3tfh"
fn.fp = file.path(PROJECT_DIR, "RESULTS/Flow_10c", ver, "DeltaThr0.5_DonorThr0.3_PercentOfParent_CORpearson_cutreeHybrid_deepSplit0_minClusterSize40_DonorScores.txt")
df.fp = fread(fn.fp) %>% 
