...
run_index = 6 # integer value in the 1:5 range
if (run_index==1) {
    model = "FP_GPgset"
    donor_group = "ALL"
    modifier = ""
...
if (model=="FB_GBpax_GBpbmc_added") {
    added_baseline_predictors = c("CXCR3pos.perc","T_CD3CD4.ct","lympho.ct","neutro.ct","mono.ct","Tfh.ct","neutro.ct_lympho.ct_ratio")
    predictor = c("sex","age",paste0("Fb0",1:9),paste0("Fb",10:83),paste0("Gb0",1:9),paste0("Gb",10:23),paste0("GbWB0",1:9),paste0("GbWB",10:19),added_baseline_predictors)
}
x = data[,predictor]
