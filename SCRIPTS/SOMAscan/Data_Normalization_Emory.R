...
path_infile = file.path(PROJECT_DIR,"DATA_ORIGINAL","Emory", "somascan", "CHI-20-009.hybNorm.plateScale.medNorm.calibrate.20200226.adat")
path_outfile = file.path(PROJECT_DIR,"DATA_PROCESSED","Emory", "somascan")
